...
namespace UseCaseSample.Common
{
    /// <summary>
    ...
    public sealed class RichTextColumns : Panel
    {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            double maxWidth = RichTextContent.DesiredSize.Width;
            double maxHeight = RichTextContent.DesiredSize.Height;
            bool hasOverflow = RichTextContent.HasOverflowContent;
